...
| 2 | 0:12–0:24 | Cut to black. Text builds line by line, one per beat. | "Projects pay upfront for promises. Promoters wait on goodwill for approval. And to qualify for anything, you hand over your social accounts to a stranger." | `pay for promises` / `wait on goodwill` / `hand over your Campaign Title` |
